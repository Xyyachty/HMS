...
@php
    ...
    $roleTints = [
        'front_desk'            => ['bg' => 'bg-amber-50',  'text' => 'text-amber-500',  'bar' => 'bg-brand'],
        ...
        'maintenance'           => ['bg' => 'bg-amber-50',  'text' => 'text-amber-500',  'bar' => 'bg-brand'],
        'housekeeping'          => ['bg' => 'bg-amber-50',  'text' => 'text-amber-500',  'bar' => 'bg-emerald-500'],
    ];
    $roleIcons = [
        'front_desk'            => 'mdi:desk',
    ...
    // Gold on cream for every icon: faculty-palette.css turns rose, blue, violet
    // and teal into one crimson that reads as red next to the maroon.
    $teamTints = ['bg-amber-50 text-amber-500'];
