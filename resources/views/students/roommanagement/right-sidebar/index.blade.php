    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar">
        ...
        <div class="px-5 py-3 border-b border-zinc-800/60 bg-zinc-900/50">
            <div class="flex items-center gap-2.5 px-3 py-2.5 rounded-xl bg-zinc-800/80 border border-zinc-700/50">
                <div class="w-6 h-6 rounded-md bg-rose-500/20 flex items-center justify-center">
                    <i class="fas fa-mouse-pointer text-[9px] text-rose-400"></i>
                </div>
        ...
        <div class="px-5 py-4 border-b border-zinc-800/60">
            <div class="flex items-center gap-2.5 mb-3">
                <div class="w-6 h-6 rounded-md bg-rose-500/15 flex items-center justify-center">
                    <i class="fas fa-clipboard-list text-[9px] text-rose-400"></i>
                </div>
