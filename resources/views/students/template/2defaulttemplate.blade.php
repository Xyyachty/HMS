...
function NavBar({ currentPage, onNav, onToggle, mobileOpen, links, brandName, editing, canEditNav, canEditBrandName, canEditLogo, onHeaderEdit, cardImages, guest, onGuestSignIn, onGuestSignOut }) {
