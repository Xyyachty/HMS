...
<style>
  ...
  .rp-muted-money { color: var(--fg-muted); font-family: 'Playfair Display', serif; font-weight: 600; }
  ...
  .rp-preset {
    ...
    background: transparent; color: var(--fg-muted);
    font-family: 'Outfit', sans-serif; font-weight: 600; font-size: 0.62rem;
  ...
  .rp-cat-room { background: rgba(201,168,76,0.18); color: #e2cc7a; border-color: rgba(201,168,76,0.35); }
  ...
  return (
    <>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '0.75rem', marginBottom: '1.35rem' }}>
        ...
        {totals.outstanding > 0 && <Tile label="Room Bills Outstanding" value={formatPeso(totals.outstanding)} tone="#fb7185" />}
      </div>
