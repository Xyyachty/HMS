...
<style>
  ...
  .hk-completed  { background: rgba(34,197,94,0.18);  color: var(--success, #4ade80); border-color: rgba(34,197,94,0.35); }
  .hk-room-available   { background: rgba(34,197,94,0.15);  color: var(--success, #4ade80); border-color: rgba(34,197,94,0.3); }
  ...
  .hk-select option { background: var(--card, #181714); color: var(--fg); }
  .hk-field-label {
  ...
  :root[data-ops-theme="2"] .hk-pending { background: #f1f5f9; color: #475569; border-color: #e2e8f0; }
  :root[data-ops-theme="2"] .hk-inspecting { background: #fef3c7; color: #b45309; border-color: #fde68a; }
  :root[data-ops-theme="2"] .hk-repair,
  :root[data-ops-theme="2"] .hk-room-maintenance { background: #f3e8ff; color: #7e22ce; border-color: #e9d5ff; }
  :root[data-ops-theme="2"] .hk-reinspect { background: #e0f2fe; color: #0369a1; border-color: #bae6fd; }
  :root[data-ops-theme="2"] .hk-completed,
  :root[data-ops-theme="2"] .hk-room-available { background: #dcfce7; color: #15803d; border-color: #bbf7d0; }
  :root[data-ops-theme="2"] .hk-room-cleaning { background: #fef3c7; color: #b45309; border-color: #fde68a; }
  :root[data-ops-theme="2"] .hk-input,
  :root[data-ops-theme="2"] .hk-select,
  :root[data-ops-theme="2"] .hk-chip { background: rgba(27,67,50,0.03); }
</style>
@endsection
...
function IssueForm({ categories, defaultCategory, onSubmit, onCancel, busy }) {
  ...
  return (
    <div style={{ marginTop: '0.9rem', paddingTop: '0.9rem', borderTop: '1px solid var(--border)' }}>
      ...
      {error && <p style={{ margin: '0.6rem 0 0', color: 'var(--danger, #fb7185)', fontSize: '0.8rem' }}>{error}</p>}
