...
<head>
    ...
    <title>HMS-Learn | Housekeeping Services</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn-primary:hover { background: #0d9488; box-shadow: 0 0 20px rgba(20,184,166,0.3); }
...
<body class="h-screen flex flex-col overflow-hidden">
    ...
    <header class="topbar h-16 flex items-center justify-between px-6 shrink-0 z-50">
        ...
        <div class="flex items-center gap-3">
            ...
            <span class="module-badge">Housekeeping Services</span>
        </div>
            ...
            <div class="relative" id="profileWrapper">
                ...
                <div class="profile-trigger" onclick="toggleDropdown()">
                    ...
                    <div class="leading-none">
                        ...
                        <p class="text-[10px] text-zinc-500 mt-0.5">Housekeeping Services</p>
                    </div>
    ...
    <div class="flex flex-1 overflow-hidden">
        <div class="w-72 shrink-0 sidebar-base border-r overflow-y-auto">
            @include('students.housekeeping.left-sidebar.index')
        </div>

        <div class="flex-1 flex flex-col min-w-0 canvas-bg">
            @include('students.housekeeping.center-canvas.index')
        </div>

        <div class="w-80 shrink-0 sidebar-base border-l overflow-y-auto">
            @include('students.housekeeping.right-sidebar.index')
        </div>
    </div>
