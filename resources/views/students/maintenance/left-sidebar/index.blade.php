    ...
    <div class="px-5 py-5 border-b border-zinc-800/80">
        <div class="flex items-start justify-between gap-3 mb-4">
            <div>
                ...
                <p class="text-[11px] text-zinc-500 mt-1">Static team list for the maintenance group</p>
            </div>
            <div class="w-9 h-9 rounded-xl bg-blue-500/15 border border-blue-400/20 flex items-center justify-center text-blue-300">
                <i class="fas fa-users text-sm"></i>
            </div>
        </div>

        <div class="settings-card mb-0">
            <span class="settings-label">Maintenance Group</span>
